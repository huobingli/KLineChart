...
export default class CustomYCustomAxis extends CustomAxis {
   ...
   */
  yAxisType () {
    return this._isCandleYAxis ? this._chartStore.styleOptions().yCustomAxis.type : YAxisType.NORMAL
  }
   ...
   */
  isReverse () {
    return this._isCandleYAxis && this._chartStore.styleOptions().yCustomAxis.reverse
  }
   ...
   */
  isFromYAxisZero () {
    const yAxisOptions = this._chartStore.styleOptions().yCustomAxis
    return (
  ...
  getSelfWidth () {
    ...
    const yAxisOptions = styleOptions.yCustomAxis
